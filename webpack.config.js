...
module.exports = {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      template: 'src/our-works.html',
      filename: 'our-works.html',
    }),
    new HtmlWebpackPlugin({
    ...
    new HtmlWebpackPlugin({
      template: 'src/pavilion.html',
      filename: 'pavilion.html',
    }),
    new HtmlWebpackPlugin({
      template: 'src/concrete-pool.html',
      filename: 'concrete-pool.html',
    }),
    new HtmlWebpackPlugin({
    ...
    new HtmlWebpackPlugin({
      template: 'src/equipment.html',
      filename: 'equipment.html',
    }),
    new HtmlWebpackPlugin({
      template: 'src/work-item.html',
      filename: 'work-item.html',
    }),
    new HtmlWebpackPlugin({
      template: 'src/equipment-category.html',
      filename: 'equipment-category.html',
    }),
